...
The code for this version is in `labs/lab-12/tasks/password-cracker/support/password-cracker-multiprocess.c`.
...
Check out the code in `labs/lab-12/tasks/password-cracker/support/password-cracker-multithread.c`.
...
Code in `labs/lab-12/tasks/password-cracker/support/python/password-cracker-multiprocess-1.py`.
...
Code in `labs/lab-12/tasks/password-cracker/support/python/password-cracker-multiprocess-2.py`.
...
Code in `labs/lab-12/tasks/password-cracker/support/python/password-cracker-multithread.py`.
