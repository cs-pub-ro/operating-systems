...
Compile and run the two programs in `labs/lab-06/tasks/sum-array-bugs/support/seg-fault/`, first with 2 processes and threads and then with 4.
...
Enter the `labs/lab-06/tasks/multithreaded/support/` directory to observe the update of the memory layout when creating new threads.
