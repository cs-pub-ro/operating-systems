...
The code in `labs/lab-07/tasks/page-faults/support/page_faults.c` generates some minor and major page faults.
...
If you're having difficulties solving this exercise, go through [this](../../guides/fork-faults/README.md) reading material.
