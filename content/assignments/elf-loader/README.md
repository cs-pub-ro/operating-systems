...
* Check the [ELF magic](https://unix.stackexchange.com/questions/153352/what-is-elf-magic), defined in [elf.h](https://chromium.googlesource.com/external/elfutils/+/dts-0.168/libelf/elf.h#120).
...
You can see more details about the stack in [How programs get run: ELF binaries](https://lwn.net/Articles/631631/).
