...
* [`os-types-interface.qmd`](os-types-interface.qmd) --- the source
* [`os-types-interface.html`](os-types-interface.html) --- the rendered deck, published with the website
...
The minimal deck used during the live delivery is in [`02-os-types-interface-live/slides/`](../../02-os-types-interface-live/slides).
...
The figures this deck references are still placeholders; see [`INSTRUCTOR.md`](../INSTRUCTOR.md) and the session `README.md` for what each one should show.
