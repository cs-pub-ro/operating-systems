...
Go to `support/wait-for-me-threads/wait_for_me_threads.c`.
...
This is precisely the nondeterminism that we talked about [in the previous section](tasks/wait-for-me-threads.md).
...
Also, at this point, you might be wondering why this exercise is written in D, while [the same exercise, but with processes](guides/wait-for-me-processes) was written in Python.
