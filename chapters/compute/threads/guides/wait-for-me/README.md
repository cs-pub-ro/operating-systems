...
This is precisely the nondeterminism that we talked about [in the previous section](../../processes/reading/processes.md#practice-wait-for-me).
...
We will discuss more fine-grained synchronization mechanisms [later in this lab](../../synchronization/reading/synchronization.md).

Also, at this point, you might be wondering why this exercise is written in D, while [the same exercise, but with processes](../../processes/reading/processes.md#practice-wait-for-me) was written in Python.
There is a very good reason for this and has to do with how threads are synchronized by default in Python.
You can find out what this is about [in the Arena section](../../arena/reading/arena.md#the-gil), after you have completed the [Synchronization section](../../synchronization/reading/synchronization.md).
